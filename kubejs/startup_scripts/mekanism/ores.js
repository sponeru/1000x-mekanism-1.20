StartupEvents.registry("item", event => {
    ...
    event.create('crystal_debri').tag('mekanism:crystals').tag('mekanism:crystals/debri')
    event.create('shard_debri').tag('mekanism:shards').tag('mekanism:shards/debri')
    event.create('clump_debri').tag('mekanism:clumps').tag('mekanism:clumps/debri')
    event.create('dirty_dust_debri').tag('mekanism:dirty_dusts').tag('mekanism:dirty_dusts/debri')
