ServerEvents.recipes(event => {
    gem_other_process('lapis',true,'forge:gems/lapis',12)
    gem_other_process('coal',true,'forge:gems/coal',4)

  function gem_other_process (material, vaporize, tagname,mult) {
    var tag_material = {
    ...
    function ore_process () {
          ...
          .outputItems(tag_to_item(tagname, 8000 * mult))
          ...
          .outputItems(tag_to_item(tagname, 3200 * mult))
        ...
        if (vaporize) {
            ...
            .outputGases(`${8000 * mult}x mek1000:vaporized_${material}`)
            ...
            .outputGases(`${3200 * mult}x mek1000:vaporized_${material}`)
      ...
      function dense_ore_process () {
          ...
          .chance(0,builder => builder.inputItems(['mek1000:module_smelting','#mek1000:ores/crystalized']))
          .outputItems(tag_to_item(tagname, 8000 * mult * 5))
          ...
          .inputItems(`#${ore.dense_ore}`)
          .chance(0,builder => builder.inputItems(['mek1000:module_smelting','#mek1000:ores/compressed_purified']))
          .outputItems(tag_to_item(tagname, 3200 * mult * 5))
        ...
        if (vaporize) {
            ...
            .outputGases(`${8000 * mult * 5}x mek1000:vaporized_${material}`)
            ...
            .outputGases(`${3200 * mult * 5}x mek1000:vaporized_${material}`)
