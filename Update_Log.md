...
# 2.7.1 アップデート
- Astral Mekanismを1.6.5に更新
- クリスタル系鉱石の倍化レシピが消滅していた不具合を修正
- カード系のスタック上限を65536に
- Derium系ブロックをインゴットに戻せるように
...
- クエストの追加
- 内部タンクの容量を増加
- Astral Mekanismを1.6.4に更新

# 2.6.4 アップデート
- ネザーウォートのレシピを追加
- ソーラーパネルのスタック数を修正
- Oversize Interfaceの内部容量を拡張
- メンリルの原木を全て破壊できるように
- クエストの追加
- 鉱石倍化のミスを修正
- 酸化レシピを追加
...
- ケーブルの変換レシピの追加
- Astral Mekanismのアップデート(1.5.2=>1.5.5)
- Polymorphの追加
- クエストの追加
- 多次元高炉の合金強化レシピを変更
- 牛関連の別レシピ追加
- 前バージョンで追加したポロニウム蒸気高速処理レシピの削除

# 2.5.1 アップデート
- 量子コンピュータの最大サイズを辺12ブロックに
- 量子コンピュータ部品のステータス変更
- Astral Mekanismの更新(1.5.0=>1.5.2)
- クオーツ混合物の追加
- ベリリウムの別レシピ追加
- クエストの加筆
- 二酸化ウランをまとめて作れるレシピの追加
- ポロニウム蒸気の高速処理レシピ
- Stoneworksセルの作成難易度緩和
- 多次元高炉の合金強化レシピを変更(3:1→2:1)
- 寒天レシピの修正
